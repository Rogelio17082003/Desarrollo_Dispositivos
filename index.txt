...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Hola, has seleccionado calculadora uno, buen dias Rogelio';
...
const DiviIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        let resultado = 0;
        resultado = numero1 * numero2;
        const speakOutput = `El resultado de la divicion de ${numero1} / ${numero2} es igual a: ${resultado}`;
...
const ModuloIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        const speakOutput = `El resultado del módulo de ${numero1} % ${numero2} es igual a: ${resultado}`;
